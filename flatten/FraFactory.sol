...
contract FraFactory is Initializable, Claimable {
    ...
    public payable returns(address _newAgreement) {
        ...
        address payable agreementProxyAddr = address(new AgreementETH());
        AgreementInterface(agreementProxyAddr).initialize.value(msg.value)(msg.sender, msg.value, _debtValue, _durationMins, _interestRate, _collateralType);
